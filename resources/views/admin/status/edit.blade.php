...
<div class="card card-outline card-primary">
    ...
    @empty($status)
        ...
        @else
        <form method="POST" action="{{ url('/admin/status/'.$status->id_detail_status) }}" class="form-horizontal">
            @csrf
            {!! method_field('PUT')!!}
            ...
            <div class="form-group row">
                ...
                <div class="col-11">
                    ...
                    <a class="btn btn-sm btn-default ml-1" href="{{ url('/admin/status') }}">Kembali</a>
                </div>
            </div>
        </form>
        @endempty
